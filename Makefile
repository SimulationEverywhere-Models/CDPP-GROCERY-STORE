...
LDFLAGS+=-L. -g
#^|
EXAMPLESOBJS=  cash.o conveyor.o distributor.o generator.o register.o searcher.o traveler.o queue.o main.o generat.o cpu.o transduc.o distri.o com.o linpack.o debug.o trafico.o
#
...
#^|
cash.o: /cygdrive/C/eclipse/workspace/test1/cash.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
conveyor.o: /cygdrive/C/eclipse/workspace/test1/conveyor.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
distributor.o: /cygdrive/C/eclipse/workspace/test1/distributor.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
generator.o: /cygdrive/C/eclipse/workspace/test1/generator.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
register.o: /cygdrive/C/eclipse/workspace/test1/register.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
searcher.o: /cygdrive/C/eclipse/workspace/test1/searcher.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
traveler.o: /cygdrive/C/eclipse/workspace/test1/traveler.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
#
...
#^|
cash.o: /cygdrive/C/eclipse/workspace/test1/cash.cpp \
 /cygdrive/C/eclipse/workspace/test1/cash.h \
 ...
 /cygdrive/C/eclipse/workspace/test1/store.h \
...
conveyor.o: /cygdrive/C/eclipse/workspace/test1/conveyor.cpp \
 /cygdrive/C/eclipse/workspace/test1/conveyor.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
distributor.o: /cygdrive/C/eclipse/workspace/test1/distributor.cpp \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/realfunc.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/real.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/undefd.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/impresion.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/tbool.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/value.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/evaldeb.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/distri.h \
 /cygdrive/C/eclipse/workspace/test1/distributor.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
...
generator.o: /cygdrive/C/eclipse/workspace/test1/generator.cpp \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/evaldeb.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/distri.h \
 /cygdrive/C/eclipse/workspace/test1/generator1.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
...
register.o: /cygdrive/C/eclipse/workspace/test1/register.cpp \
 ...
 /cygdrive/C/eclipse/workspace/test1/cash.h \
 /cygdrive/C/eclipse/workspace/test1/distributor.h \
 /cygdrive/C/eclipse/workspace/test1/traveler.h \
 /cygdrive/C/eclipse/workspace/test1/searcher.h \
 /cygdrive/C/eclipse/workspace/test1/conveyor.h
searcher.o: /cygdrive/C/eclipse/workspace/test1/searcher.cpp \
 /cygdrive/C/eclipse/workspace/test1/searcher.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
